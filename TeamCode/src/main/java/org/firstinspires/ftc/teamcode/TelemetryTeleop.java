    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            craterArmServo.setPosition(0);
                ...
                telemetry.addData("Intake SLide Motor", intakeSlideMotor.getCurrentPosition());
                telemetry.addData("Intake Fold Motor", intakeFold.getCurrentPosition());
                telemetry.addData("Left Distance Sensor", distanceSensorLeft.getDistance(DistanceUnit.MM));
                telemetry.addData("Right Distance Sensor", distanceSensorRight.getDistance(DistanceUnit.MM));
                telemetry.update();
           ...
           if (gamepad1.left_bumper) {
            ...
            if (gamepad2.y) {
                liftMotor.setTargetPosition(4250);
